...
Over the coming months we're excited to extend the application to more assays and include more advanced features. Things like group selections/dragging and user preferences for controls/sample placement are at the top of the list for future work!
